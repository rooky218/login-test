...
box-shadow: 2px 5px 17px 1px rgba(0,0,0,0.75); padding-top: 30px; padding-bottom: 30px;">Mary Bethune Content Management System</h1>
	...
	<ul class="mainlinks">
		<li><a id="active" href="loginmain.php">Write a Post</a></li>
		<li><a href="loginevent.php">Create an Event</a></li>
...
<form class="indexpost" action="../include/layout/mysqlQ/newpost.php" method="post">
	...
	<textarea name="makepost" rows="2" cols="60" style="font-size:18px" placeholder="What's on your mind?"></textarea>
	<br />
