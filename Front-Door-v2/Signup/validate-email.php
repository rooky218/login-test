...
<div class="row">
  <div class="col-md-3"></div><!--off set-->
    <div class="col-md-6">
      ...
      <div id="conf-e" class="panel panel-primary" style="min-height: 250px; width: 400px; margin-left: auto; margin-right: auto; margin-top: 300px;">

        <h3 class="panel-heading text-center" style="margin-top: 0px;">Please Confirm Email</h3>
